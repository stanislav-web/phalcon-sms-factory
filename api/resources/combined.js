...
ApiGen.config = {
    ...
    "config": "\/usr\/share\/php\/data\/ApiGen\/templates\/default\/config.neon"
};
 ...
 */(function (e)
{
    var t = {
        ...
        {
            return t = parseInt(t, 10), e = parseFloat(e), isNaN(t && e) ? NaN : t && e.toFixed(t) || e
        }, o: function (e)
        {
    ...
    {
        if (e.length == 1 && typeof e[0] == "object")return e = e[0], function (n, r, i, s, o, u, a)
        {
            return t[o](e[s])
        };
        var n = 0;
        return function (r, i, s, o, u, a, f)
        {
            return u == "%" ? "%" : t[u](e[n++], s)
        }
    };
